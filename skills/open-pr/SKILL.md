...
**Assess branch state**. Check the current git branch, unpushed commits, and recent commit messages to understand the scope of changes.
   *Completion criterion*: You have gathered all necessary context to describe the changes.

**Draft the pitch**. Generate a concise PR title and a descriptive body. 
...
**Execute creation**. Once the user approves or modifies the draft, create the pull request using the GitHub CLI (`gh pr create`).
